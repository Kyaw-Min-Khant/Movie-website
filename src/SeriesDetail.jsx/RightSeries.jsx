...
import RightSimilarCard from "./RightSimilarCard";
const RightSeries = () => {
  ...
  const similarFetch = async () => {
    const apiFetch = await fetch(
      `https://api.themoviedb.org/3/tv/${similarId}/similar?api_key=a6af80b02b99c9fae32ba3c9259d4844&language=en-US&page=1`
    );
